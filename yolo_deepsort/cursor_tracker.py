...
from yolo_deepsort.core import utils
from yolo_deepsort.core.yolov4 import filter_boxes
from tensorflow.python.saved_model import tag_constants
from yolo_deepsort.core.config import cfg
...
def track_cursor(path_to_video, path_to_weight, input_size=416, framework='tf', model='yolov4', iou_threshold=0.45, score_threshold=0.50, draw_bbox=False, show_fps=False):
    ...
    model_filename = 'model_data/camstroke_21012021.pb'
